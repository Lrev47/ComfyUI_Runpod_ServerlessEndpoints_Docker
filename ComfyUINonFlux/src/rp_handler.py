...
COMFY_API_AVAILABLE_INTERVAL_MS = 50  # Wait 50ms between retries
# Maximum number of API check attempts
COMFY_API_AVAILABLE_MAX_RETRIES = 500  # Total wait time: 50ms * 500 = 25 seconds
...
def handler(job):
    ...
    if job_input.get("action") == "warmup":
        ...
        # Prepare a minimal workflow that loads the model and performs a small inference
        minimal_workflow = {
            "1": {
