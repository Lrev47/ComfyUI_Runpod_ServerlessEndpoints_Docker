...
# Define the source and destination directories for custom nodes
...
# ---------------------------------------------------------------------------
# The following section is commented out to disable copying models from
# network storage to local directory. If you need to revert back to copying
# models locally, simply uncomment this section.
# ---------------------------------------------------------------------------
...
if [ "$SERVE_API_LOCALLY" == "true" ]; then
    ...
    echo "Listing available UNet models:"
    ls -l /runpod-volume/ComfyUI/models/unet/

    echo "Listing available CLIP models:"
    ls -l /runpod-volume/ComfyUI/models/clip/

    echo "Listing available LoRA models:"
    ls -l /runpod-volume/ComfyUI/models/loras/

    echo "Listing available VAE models:"
